...
export class DbService {
  ...
  public loadSeances() {
    let url = `/api/ABS_ComposantSectionAPI/GetIntvSeances/${this.userData?.Intv_Id}/${this.userData.Ann_Id}`;
    this.getData(url)
      .then((data) => {
  ...
  public loadMesMatieres() {
    let url = `/api/ABS_ComposantSectionAPI/GetComposantSection/${this.userData?.Intv_Id}/${this.userData.Ann_Id}`;
    this.getData(url)
      .then((data) => {
  ...
  public loadMaProgression() {
    let url = `/api/ABS_ComposantSectionAPI/getSeancesProgress/${this.userData?.Intv_Id}/${this.userData.Ann_Id}`;
    this.getData(url)
      .then((data) => {
  ...
  //#region Etudiant
  public getRevisions() {
    let url = `/api/NEL_RevisionAPI/getLoggedEtudiantRevisions/${this.userData.Etd_Matricule}`;
    return this.getData(url)
  }
  public loadDemandeDocuments() {
    let url = `/api/INS_DocDemandeController/getDemandeOfStudent/${this.userData.Etd_Matricule}`;
    return this.getData(url)
  }
  public loadAgendaEtd() {
    let url = `/api/ABS_SeanceAPI/GetEtdAgenda1/${this.userData.Etd_Matricule}`;
    return this.getData(url)
  }
  public loadEtdSeances() {
    let url = `/api/ABS_SeanceAPI/GetEtdSeances/${this.userData.Etd_Id}`;
    return this.getData(url)
  ...
  public getNbRevisionsSms(matric, Sms_Nom, fac_Id) {
    let url = `/api/NEL_RevisionAPI/getNbRevisions/${matric}/${Sms_Nom}/${fac_Id}`;
    return this.getData(url)
  }
  public CheckEtudiantMatricule(matricule) {
    let url = `/api/AccountAPI/CheckEtudiantMatricule/${matricule}`;
  ...
  checkRepechage(sms) {
    let url = `/api/EtudiantCoursEvaluation/CheckIfRepechage/${this.userData?.Etd_Matricule}/${sms}`;
    return this.getData(url);
  }
  ...
  createDS(response) {
    ...
    if (!dataSource.smsActuel) {
      ...
      HelperService.SetLocalStorage('Fac_Id', dataSource.smsActuel.Fac_Id);
